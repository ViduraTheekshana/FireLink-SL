...
import PreventionOfficerDashboard from "./pages/PreventionManagement/PreventionOfficerDashboard";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/officer-dashboard" element={<PreventionOfficerDashboard />} /> 
